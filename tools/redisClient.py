...
from config.configfile import (
    REDIS_KEY,
    REDIS_ACCESSTOKEN_KEY,
    REDIS_PORT,
    REDIS_PASSWORD,
    REDIS_HOST,
...
class RedisClient(CreateClientBase):
    """
...
class RedisAccessToken(CreateClientBase):
    ...
    def add_access_token(self, access_token):
        ...
        :return:
        """
        return self.redis.set(REDIS_ACCESSTOKEN_KEY, access_token, ex=10)

    def get_access_token(self):
        access_token = self.redis.get(REDIS_ACCESSTOKEN_KEY)
        return str(access_token, encoding='utf-8')


if __name__ =='__main__':
    result = RedisAccessToken()
    # print(result.add_access_token('123354435'))
    print(result.get_access_token())
